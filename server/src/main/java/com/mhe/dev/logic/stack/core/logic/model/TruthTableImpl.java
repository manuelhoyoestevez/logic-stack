...
public class TruthTableImpl implements TruthTable
{
    ...
    /**
     * Valores: Las claves enteras en binario representan los literales revertidos. Ejemplo: Literals: [a, b, c, d],
     * clave 13 (1101) d = 1, c = 1, b = 0, a = 1
     */
    ...
    public TruthTableImpl(List<String> literals, Map<Integer, Boolean> values) throws TruthTableException
    {
        ...
        {
            throw new TruthTableException(
                "Truth table have too many literal: " + literals.size() + ". Maximum is " + MAX_LITERALS);
        }
        ...
        {
            throw new TruthTableException(
                "Truth table have too many entries: " + values.size() + ". Maximum is " + maximum);
        }
        ...
        for (Map.Entry<Integer, Boolean> entry : this.values.entrySet())
        {
            ...
            {
                throw new TruthTableException(
                    "Invalid key in values: " + key + ". Must be between [0, " + (maximum - 1) + "]");
            }
