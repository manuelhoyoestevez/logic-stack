...
public abstract class Lexer implements LexerInterface {
	 ...
	 */
	protected abstract int compileToken() throws IOException;
	...
	@Override
	public int matchToken(int t) throws Exception {
	...
	@Override
	public TokenInterface getNextToken() throws IOException {
		this.getNextTokenCategory();
		return this.getCurrentToken();
	}
	
	@Override
	public int getNextTokenCategory() throws IOException{
